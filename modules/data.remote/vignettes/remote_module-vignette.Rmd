...
This vignette assumes that you are running the PEcAn docker stack on your local machine at port 8000.
...
Open RStudio by visiting `http://localhost:8000/rstudio/` the default username is carya and the password is illinois.

Create a new file named pecan.xml, in it copy the below contents. Make sure to enter your own path in `<outdir>` and `<dbfiles>`.
